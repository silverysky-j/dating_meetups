...
const dinners: Dinner[] = [
  {
    id: 1, title: "Бегуны", age: "25–30", format: "ужин", date: "2 августа, сб", time: "19:30",
  ...
  {
    id: 3, title: "Йога", age: "25–30", format: "ужин", date: "16 августа, сб", time: "19:00",
  ...
  {
    id: 5, title: "Смена и друзья", age: "27–35", format: "ужин", date: "30 августа, сб", time: "19:30",
    area: "Центр · Москва", restaurant: "354 Exclusive", price: "1 600 ₽", priceNum: 1600,
    spotsM: 1, spotsF: 0, emoji: "✂️", tag: "Медиа",
    description: "Стол вокруг аудитории медиа «Смена» и смежных комьюнити — люди, которые читают одно и то же, думают похоже и, скорее всего, уже знают друг друга по одному рукопожатию.",
    criteria: "Возраст 27–35 лет. Связь со «Сменой» или смежными медиа/арт-комьюнити. Интервью перед подтверждением.",
    question: "Откуда ты про нас узнал и как связан со «Сменой» или медиапространством вокруг неё?",
  },
  {
    id: 6, title: "Хегай и друзья", age: "27–35", format: "ужин", date: "6 сентября, сб", time: "19:30",
    area: "Центр · Москва", restaurant: "Китайская грамота", price: "1 600 ₽", priceNum: 1600,
    spotsM: 2, spotsF: 1, emoji: "🎨", tag: "Арт",
    description: "Стол вокруг арт- и культурного комьюнити Москвы. Галеристы, художники, кураторы, коллекционеры — и все, кто живёт в этом пространстве.",
    criteria: "Возраст 27–35 лет. Причастность к арт-сцене — работа, практика или активный интерес. Анкету читаем внимательно.",
    question: "Как ты связан с арт-сообществом? Чем занимаешься — создаёшь, продаёшь, поддерживаешь?",
  },
  {
    id: 7, title: "Что-то на богатом", age: "25–30", format: "ужин", date: "13 сентября, сб", time: "20:00",
    area: "Центр · Москва", restaurant: "White Rabbit", price: "16 000 ₽", priceNum: 16000,
    spotsM: 1, spotsF: 1, emoji: "🍷", tag: "Премиум",
    description: "Ужин без конкретного комьюнити — просто интересные люди 25–30, которые умеют получать удовольствие от хорошего ресторана. Отбор строже — анкета и разговор с организатором.",
    criteria: "Возраст 25–30 лет. Высокая планка отбора: интересный бэкграунд, умение держать разговор. Проводим короткий звонок перед подтверждением.",
    question: "Чем занимаешься, что тебя интересует помимо работы и почему решил подать заявку именно на этот стол?",
  },
];
