...
const dinners: Dinner[] = [
  {
    id: 7, title: "Смена и друзья", ageRanges: ["27–35", "35-45"], format: "ужин", date: "3 августа, пн", time: "19:30",
    area: "Центр · Москва", price: "800 ₽", priceNum: 800,
    spotsM: 1, spotsF: 1, emoji: "🏕️", tag: "Комьюнити",
    description: "Стол для участников комьюнити «Станция Смена» — коворкинга-лагеря для удалёнщиков. Приходи сам или закинь приглашение другу, которому давно пора открыть сердце!",
    criteria: "Возраст групп 27–35 лет и 35-45 лет. Если вам 35 — выбирайте группу на свое усмотрение :). Причастность к «Станции Смена» — участник или приглашённый друг участника.",
  ...
  },
  {
    ...
    area: "Центр · Москва", price: "1 600 ₽", priceNum: 1600,
    spotsM: 1, spotsF: 0, emoji: "🔥", tag: "Культура",
...
const faqItems = [
  ...
  { q: "Что если я не смогу прийти?", a: "Если отменяешь бронь не позднее чем за 48 часов до встречи — вернём полную сумму. Если позже и вместе с нами не получится найти замену — оплата, к сожалению, не возвращается." },
  { q: "А если отменится кто-то другой?", a: "Если из стола выбывает участник противоположного вам пола, мы вернём треть стоимости — потому что знакомств на встрече будет меньше. Минимальный состав, с которым стол ещё состоится, — двое мужчин и две женщины. Если отменится больше людей, мы напишем об отмене всей встречи и вернем деньги." },
        ...
        <div className="max-w-5xl mx-auto px-5 py-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { emoji: "🎯", title: "Без ожиданий", desc: "Может получиться просто приятный вечер, может дружба, а может что-то большее." },
              { emoji: "📍", title: "Место выбираем мы", desc: "Уютный ресторан в центре города — детали пришлём заранее." },
            ].map((item, i) => (
